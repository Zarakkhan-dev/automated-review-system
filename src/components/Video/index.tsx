    ...
    <>
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            title="Empowering Your Feedback Strategy"
            paragraph="We make it easier than ever to understand your audience through smart video-driven review analysis. Watch how our system works."
            center
            mb="80px"
          />
        </div>

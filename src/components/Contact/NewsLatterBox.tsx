...
const NewsLatterBox = () => {
  ...
  return (
      ...
      <h3 className="mb-4 text-2xl leading-tight font-bold text-black dark:text-white">
        Stay Updated with ARS
      </h3>
      <p className="border-body-color/25 text-body-color mb-11 border-b pb-11 text-base leading-relaxed dark:border-white/25">
        Subscribe to receive the latest updates on AI-powered review technology, chatbot enhancements, new feature releases, and expert tips to boost your business with ARS.
      </p>
      <div>
        <input
          type="text"
